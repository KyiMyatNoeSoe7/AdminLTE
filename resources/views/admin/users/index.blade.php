                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- <td>
                                ...
                                @else
                                <form action="{{ route('admin.upload_file', $user->id) }}" method="post" enctype="multipart/form-data" class="dropzone dz-clickable" id="myDropzone">
                                    @csrf
                                    @method('put')
                            ...
                            <td>
                                <form action="{{ route('admin.users.destroy', $user->id) }}" method="post">
                                    ...
                                    <a href="{{ route('admin.users.edit', $user->id) }}"  class="btn btn-success m-1" title="Edit" data-toggle="tooltip"><i class="fa fa-pen"></i></a>
